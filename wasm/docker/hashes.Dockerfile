...
# ripemd160
COPY wasm/hashes/ripemd160 /bsv/wasm/hashes/ripemd160
WORKDIR /bsv/wasm/hashes/ripemd160
...
RUN cp -r /bsv/wasm/hashes/ripemd160/out/ripemd160 /bsv/bin

# sha256
COPY wasm/hashes/sha256 /bsv/wasm/hashes/sha256
WORKDIR /bsv/wasm/hashes/sha256
...
RUN cp -r /bsv/wasm/hashes/sha256/out/sha256 /bsv/bin

# sha512
COPY wasm/hashes/sha512 /bsv/wasm/hashes/sha512
WORKDIR /bsv/wasm/hashes/sha512
...
RUN cp -r /bsv/wasm/hashes/sha512/out/sha512 /bsv/bin

# sha1
COPY wasm/hashes/sha1 /bsv/wasm/hashes/sha1
WORKDIR /bsv/wasm/hashes/sha1
...
RUN cp -r /bsv/wasm/hashes/sha1/out/sha1 /bsv/bin

WORKDIR /bsv/wasm/hashes/

# copy outputs to mounted volume
CMD ["cp", "-r", "/bsv/bin", "/bsv/out"]