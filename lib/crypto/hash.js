 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
Hash.sha256 = async function (buf) {
  $.checkArgument(Buffer.isBuffer(buf))
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
Hash.sha256sha256 = async function (buf) {
  $.checkArgument(Buffer.isBuffer(buf))
  return Hash.sha256(await Hash.sha256(buf))
}
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
Hash.ripemd160 = async function (buf) {
  $.checkArgument(Buffer.isBuffer(buf))
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
Hash.sha256ripemd160 = async function (buf) {
  $.checkArgument(Buffer.isBuffer(buf))
  return Hash.ripemd160(await Hash.sha256(buf))
}
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
Hash.sha512 = async function (buf) {
  $.checkArgument(Buffer.isBuffer(buf))
 ...
 */
Hash.hmac = async function (hashf, data, key) {
  ...
  return hashf(Buffer.concat([oKeyPad, await hashf(Buffer.concat([iKeyPad, data]))]))
}
 ...
 * @returns {Buffer} The HMAC in the form of a buffer.
 */
Hash.sha256hmac = async function (data, key) {
 ...
 * @returns {Buffer} The HMAC in the form of a buffer.
 */
Hash.sha512hmac = async function (data, key) {
