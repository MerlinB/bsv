 ...
 */
Interpreter.prototype.verify = async function (scriptSig, scriptPubkey, tx, nin, flags, satoshisBN) {
 ...
 * bitcoind commit: b5d1b1092998bc95313856d535c632ea5a8f9104
 */
Interpreter.prototype.evaluate = async function () {
 ...
 * bitcoind commit: b5d1b1092998bc95313856d535c632ea5a8f9104
 */
Interpreter.prototype.step = async function () {
  var self = this
    ...
    switch (opcodenum) {
      ...
      case Opcode.OP_HASH256:
        ...
        if (opcodenum === Opcode.OP_RIPEMD160) {
          ...
          bufHash = await Hash.sha1(buf)
        } else if (opcodenum === Opcode.OP_SHA256) {
          bufHash = await Hash.sha256(buf)
        } else if (opcodenum === Opcode.OP_HASH160) {
          bufHash = await Hash.sha256ripemd160(buf)
        } else if (opcodenum === Opcode.OP_HASH256) {
          bufHash = await Hash.sha256sha256(buf)
        }
        this.stack.pop()
