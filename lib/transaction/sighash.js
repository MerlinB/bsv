...
var sighashForForkId = async function (transaction, sighashType, inputNumber, subscript, satoshisBN) {
  ...
  async function GetPrevoutHash (tx) {
    ...
    var ret = await Hash.sha256sha256(buf)
    return ret
  }

  async function GetSequenceHash (tx) {
    var writer = new BufferWriter()
  ...
  async function GetOutputsHash (tx, n) {
    var writer = new BufferWriter()
 ...
 *
 */
var sighash = async function sighash (transaction, sighashType, inputNumber, subscript, satoshisBN, flags) {
